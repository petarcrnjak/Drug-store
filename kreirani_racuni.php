...
$upit = "select distinct r.idRacuni,r.Korisnik,r.iznos,r.datum from Racuni as r left join Stavke as s on r.idRacuni=s.Racuni left join "
        . " Rezervacije as re on re.idRezervacije=s.Rezervacije left join Korisnik as k on k.id_korisnik=r.Korisnik where r.Korisnik='" . $korisnik . "'";
...
$smarty->display('kreirani_racuni.tpl');

...
<section id="sadrzaj">
    <h1>Definiranje Akcija</h1>
    <article>
        <form name="rezervacija" id="rezervacija" method="POST" enctype='multipart/form-data' action="definiranjeAkcija.php">
            ...
            <label for="lijekovi"> ID lijeka: </label>
            <input type="txt" id="lijekovi" name="lijekovi" placeholder="id lijeka"><br><br>

            <label for="snizenost"> sniženost lijeka (%): </label>
            <input type="number" step="any" id="snizenost" name="snizenost" placeholder="postotak snizenosti"><br><br>
